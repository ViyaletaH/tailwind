...
{
    /* changeProvider tests */ async function testForRegistry(registry, n, v, isNull = false) {
        const mdl = {
            pkg: {
                name: n,
                version: v,
    ...
    await testForRegistry("node_modules", "chalk", encodeBase64(new URL("./node_modules/chalk/", rootUrl).href));
}
